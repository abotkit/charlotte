...
class MinioHandler(IObjectStorageHandler):
    ...
    def bucket_exists(self, bucket_name: str):
        try:
            ...
            print(f"Minio make bucket exception: {str(e)}")
